...
def emotion_detector(text_to_analyze):
    ...
    Args:text_to_analyze (str): The input text string to analyze for emotions.
    Returns:dict: A dictionary containing emotion scores for anger, disgust, fear, joy, sadness,
    ...
    emotions = {}
    #Check if status code of response is OK
    ...
    # Check if status code for an error in the request
        ...
        # Otherwise print aan error message
